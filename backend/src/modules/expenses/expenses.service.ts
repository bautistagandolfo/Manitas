...
export class ExpensesService {
  ...
  //
  // Explícitamente NO chequea sesión de caja abierta ni genera ningún
  // `cash_movement`, sin importar `medioPago` (ni siquiera EFECTIVO):
  // eso es responsabilidad de T6.3 ("Gasto en efectivo → movimiento de
  // caja vinculado"), un ticket separado — mismo precedente que
  // `returns` dividió T5.1 ("devolución simple", sin reintegro) de T5.3
  // ("reintegro en efectivo → movimiento de caja", agregado después).
